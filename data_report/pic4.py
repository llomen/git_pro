...
workbook = xlsxwriter.Workbook('pic4.xlsx')
...
s1 = '=Sheet1!$A$2:$A$' + str(len(list[0])+1)
s2 = '=Sheet1!$B$2:$B$' + str(len(list[1])+1)
s3 = '=Sheet1!$C$2:$C$' + str(len(list[2])+1)
...
s4 =  '=Sheet1!$D$2:$D$' + str(len(bug_list_creat_total)+1)
s5 =  '=Sheet1!$E$2:$E$' + str(len(bug_list_close_total)+1)
